...
createErrorFromNameLookup.set(
  ...
  () => new CannotExchangeSOLForSolError()
);
  ...
  constructor() {
    ...
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(
        this,
        CannotTakeThisActionWithoutAuctionHouseSignOffError
      );
    }
  }
}
...
/**
 * CannotMatchFreeSalesWithoutAuctionHouseOrSellerSignoff: 'Cannot 
 * match free sales unless the auction house or seller signs off'
 */
export class CannotMatchFreeSalesWithoutAuctionHouseOrSellerSignoffError extends Error {
  ...
  constructor() {
    ...
    if (typeof Error.captureStackTrace === "function") {
      Error.captureStackTrace(
        this,
        CannotMatchFreeSalesWithoutAuctionHouseOrSellerSignoffError
      );
    }
  }
}
...
createErrorFromNameLookup.set(
  ...
  () => new OldSellerNotInitializedError()
);
